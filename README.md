#  actualiza-datos-generales-client-java

<p>Actaulizacion de datos generales.<br/><img src='https://github.com/APIHub-CdC/imagenes-cdc/blob/master/circulo_de_credito-apihub.png' height='37' width='160'/></p><br/>
...
En el archivo **ReporteDeCrditoApiTest**, que se encuentra en ***src/test/java/io/ActualizaDatosGenerales/client/api/***. Se deberá modificar los datos de la petición y de la URL para el consumo de la API en ***setBasePath("the_url")***, como se muestra en el siguiente fragmento de código con los datos correspondientes:
